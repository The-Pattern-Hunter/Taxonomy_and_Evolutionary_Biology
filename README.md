...
| :--- | :--- | :--- | :--- |
| 1.1 | **Taxonomic Key Constructor** | Building dichotomous keys, binary logic, and character weighting. | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/The-Pattern-Hunter/Taxonomy_and_Evolutionary_Biology/blob/main/notebooks/Lab_1_1_Taxonomic_Keys.ipynb) |
...
1. **Open:** Click the "Open in Colab" badge for your desired lab.
2. **Setup:** Run the first code cell in every notebook (labeled **GOOGLE COLAB SETUP**) to enable the interactive widgets and Plotly charts.
3. **Interact:** Use the sliders, dropdowns, and buttons to run simulations.
4. **Save:** If you wish to save your progress, go to `File > Save a copy in Drive`.

## 📌 Features
* **Zero Installation:** Works entirely in the cloud.
